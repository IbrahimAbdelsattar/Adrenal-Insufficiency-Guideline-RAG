...
def test_generation_quality(monkeypatch):
    ...
    from backend.app.models import RetrievalResult, Chunk
    ...
    for case in cases:
        class MockRetriever:
            def search(self, query: str, top_k: int) -> list:
                ...
                c = Chunk.from_stored("c1", "Mock text", {
                    "doc_id": "test", "document_name": "Test", "source_url": "",
                    "document_type": "guideline", "publication_year": 2024, "requires_caution": False,
                    "page_number": 1, "section_title": "", "section_number": "", "subsection_title": "",
                    "recommendation_ids": "", "token_count": 10, "is_oversized": False
                })
